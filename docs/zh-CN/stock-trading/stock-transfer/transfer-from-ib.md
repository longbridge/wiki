...
# 从盈透证券（含老虎、雪盈底层 IB）转入股票

从盈透证券（IB）转入股票，**港股和美股流程完全不同**，请根据转入股票类型分别操作。

> **适用范围**：IB 个人账户。雪盈证券（底层为 IB）操作类似但有差异，请参考 [从雪盈证券转仓到长桥证券](/stock-trading/stock-transfer/transfer-from-snowball)。老虎证券用户请参考 [从老虎证券转仓到长桥证券](/stock-trading/stock-transfer/transfer-from-tiger)。
>
...
登录 [IB 官网](https://www.interactivebrokers.com.hk/cn/home.php)，按股票市场选择对应流程：
