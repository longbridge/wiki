...
zendesk_updated_at: '2026-09-01T03:28:12Z'
...
1.  Go to _Buying Power_.

2.  If margin investing is currently disabled, you'll see an _Enable Margin Investing_ card with your applicable margin rate.

3.  Tap _Enable now_.

4.  Review the confirmation screen, which explains:

    -   Enabling margin lets you borrow funds to purchase securities and act on market opportunities beyond your available cash.

    -   Your borrowing capacity is determined by the value of eligible securities in your account.

5.  Tap _Enable now_ to confirm, or _Cancel_ to go back.

**Note:** Turning on margin investing does not always grant you immediate borrowing power. If your account's start-of-day assets are at least $2,000, you'll gain margin capacity right away. If your account balance is below $2,000, margin investing will be turned on, but you won't have actual borrowing capacity until your account qualifies — you'll see a notice in the _Margin Details_ section explaining this.

## How to disable margin investing

1.  Go to _Buying Power_ and tap the settings icon to open _Margin Settings_.

2.  Turn off the _Margin investing_ toggle.

3.  Review the confirmation screen. If your account holds unsecured options, you'll see an additional notice:
...
4.  Tap _Disable_ to confirm, or _Cancel_ to go back.

### What happens when you disable margin investing

-   Your borrowing power is revoked immediately.

-   Your account is limited to cash-only trading.
