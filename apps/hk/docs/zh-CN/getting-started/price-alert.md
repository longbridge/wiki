...
- **iPhone**：设置 → 长桥 App → 通知 → 允许通知 [点击此处进入设置首页](lb://page/mine/setting)

- **Android**：设置 → 应用管理 → 长桥 → 通知 → 开启 [点击此处进入设置首页](lb://page/mine/setting)

没有开启通知权限，提醒触发后你不会收到推送。

也可以在长桥 App 内，通过【左上角头像】→【设置】→【消息设置】管理通知偏好。 [点击此处进入通知设置页面](lb://page/settings/notification)
...
点击 App 任意页面右上角的**搜索图标（🔍）**。 [点击此处进入全局搜索页面](lb://page/discovery/search-stocks)
