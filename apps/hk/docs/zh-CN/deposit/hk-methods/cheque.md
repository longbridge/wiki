...
- 支票正面示例： 
![](./images/DYbtb2JrQoshu3xSqF7j2Pmcpp8.png)

- 支票反面示例： 
![](./images/WVN7bybF7oBseMxSgaejyTT4pfb.png)

1. 将支票递交至银行柜台或存支票机，保留转账凭证截图

- 存支票机转账凭证示例： 
![](./images/IRzFbndE7oVqURxTSQQjjBocpIe.png)

- 柜台转账凭证示例： 
![](./images/R6n3bGYvSoJkUoxHNpLjdK57pFd.png)

1. 打开长桥 App，进入**资产 → 存入资金 → 支票转账**，上传支票正面、反面截图和转账凭证 [点击此处办理资金入账](lb://page/mine/deposit)
