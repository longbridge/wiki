...
![](./images/IidfbGrVNoVCCdx6ToFjiv5qpKb.png)
...
第一次操作选轻度价外即可。行权价与权利金的取舍关系，见期权买方。
...
在下单面板中： 1. 确认方向：**买入（Buy to Open）** 2. 数量：填 **1**（张） 3. 委托类型：选**限价**，价格填当前 Ask 价（或略高 1–2 分以确保成交） 4. 确认预估总金额（即你需要支付的权利金） 5. 点击提交，再点确认
...
你会看到刚才买入的期权合约，显示： - 持仓数量：1 张（正数 = 多头 = 买方权利） - 权利金成本：你支付的总金额 - 当前市值：随标的股价实时变化
