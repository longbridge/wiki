...
结构化产品（又称结构性产品）是金融机构发行的投资工具，多以票据形式存在，通过结合固定收益资产与金融衍生品，匹配不同风险收益特征，以满足投资者的差异化配置需求。适合对特定市场走势有判断、追求条件性增强收益的投资者。入口在「市场」→「财富」→「结构化产品」。 [点击此处进入市场页面](lb://page/market/tab)
...
**标的类型**： - 指数雪球：挂钩恒生指数（HSI）、恒生科技指数（HSTECH）等 - 个股雪球：挂钩 META、台积电（TSM）、阿里巴巴（BABA）等个股
...
### 逐步递减自动敲出票据（Step-Down Autocallable Note）

敲出触发（Autocall Trigger Level）价格随时间逐步降低或票息率（Coupon Rate） 阶梯式下行的雪球变体，越临近到期越容易触发敲出，增加提前结束概率。
