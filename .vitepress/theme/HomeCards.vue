...
const categories = [
  ...
  },
  {
    ...
    link: '/交易市场与规则/',
    links: [
      { text: '港股交易规则与结算', link: '/交易市场与规则/港股交易/港股交易规则与结算' },
      { text: '美股交易规则与结算', link: '/交易市场与规则/美股交易/美股交易规则与结算' },
      { text: '美股卖空', link: '/交易市场与规则/美股交易/美股卖空' },
      { text: '新加坡股票交易规则', link: '/交易市场与规则/新加坡股票交易/新加坡股票交易规则与结算' },
    ]
  },
  {
    svg: S.orders,
    ...
    link: '/订单类型/',
    links: [
      { text: '限价单与市价单', link: '/订单类型/普通订单/限价单与市价单' },
      { text: 'FOK 与 IOC 订单', link: '/订单类型/普通订单/FOK与IOC订单' },
      { text: '附加订单', link: '/订单类型/条件订单/附加订单' },
      { text: '网格交易', link: '/订单类型/策略订单/网格交易' },
    ]
  },
  {
    svg: S.fee,
    ...
    link: '/交易费用/',
    links: [
      { text: '交易收费说明', link: '/交易费用/交易收费' },
      { text: '港股佣金计算示例', link: '/交易费用/港股佣金计算示例' },
      { text: '美股佣金计算示例', link: '/交易费用/美股佣金计算示例' },
    ]
  },
  {
    svg: S.quote,
  ...
  },
  {
    ...
    link: '/产品功能/',
    links: [
      { text: 'LongbridgeAI 信息助手', link: '/产品功能/客户端功能/LongbridgeAI信息助手' },
      { text: '图表交易', link: '/产品功能/桌面端功能/图表交易' },
      { text: '市场深度', link: '/产品功能/桌面端功能/市场深度' },
      { text: '桌面端快捷键', link: '/产品功能/桌面端功能/桌面端快捷键' },
    ]
  },
  {
    svg: S.derivatives,
