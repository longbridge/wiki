...
const categories = [
  ...
  },
  {
    ...
    link: '/开户与账户/',
    links: [
      { text: '开通香港综合账户', link: '/开户与账户/开通香港综合账户' },
      { text: '开通新加坡综合账户', link: '/开户与账户/开通新加坡综合账户' },
      { text: '登录注册', link: '/开户与账户/登录注册' },
      { text: '账户常见问题', link: '/开户与账户/账户常见问题' },
    ]
  },
  {
    svg: S.deposit,
  ...
  },
  {
    ...
    link: '/活动与奖励/',
    links: [
      { text: '奖励系统概览', link: '/活动与奖励/奖励系统概览' },
      { text: '任务中心概览', link: '/活动与奖励/任务中心概览' },
      { text: '邀请活动', link: '/活动与奖励/邀请活动' },
      { text: '兑换商城', link: '/活动与奖励/兑换商城' },
    ]
  },
  {
    svg: S.compliance,
...
.hp-hero::before {
  ...
  width: 500px;
  height: 500px;
  background: radial-gradient(circle, rgba(0, 184, 184, 0.08), transparent);
  border-radius: 50%;
  pointer-events: none;
}
...
.hp-cat {
  padding: 24px;
  border-radius: 12px;
  border: 1px solid rgba(0, 184, 184, 0.1);
  background: linear-gradient(
    135deg,
...
.hp-cat::before {
  ...
  width: 200px;
  height: 200px;
  background: radial-gradient(circle, rgba(0, 184, 184, 0.1), transparent);
  border-radius: 50%;
...
.hp-cat:hover {
  ...
  box-shadow: 0 8px 24px rgba(0, 184, 184, 0.12);
...
.hp-cat:hover .hp-cat-icon {
  background: rgba(0, 184, 184, 0.2);
  transform: scale(1.1);
}

.hp-cat-icon :deep(svg) {
  width: 18px;
  height: 18px;
  stroke-width: 1.5;
}
...
.hp-cat-links li a:hover::before {
  height: 16px;
}

/* ── 响应式 ─────────────────────────────────── */
@media (max-width: 1200px) {
  .hp-grid { grid-template-columns: repeat(3, 1fr); gap: 24px 36px; }
}
