...
const ORDER: Record<string, string[]> = {
  ...
  // 产品功能
  '产品功能': ['行情与数据', '交易工具', '资产与持仓', '账户与设置', '活动与奖励', '全部功能'],
  '产品功能/行情与数据': ['LongbridgeAI信息助手', '市场行情', '发现', '动态', '搜索', '自选', '股单', '行情商店'],
  '产品功能/交易工具': ['图表交易', '市场深度', '组件布局与拼接', '桌面端快捷键'],
  '产品功能/资产与持仓': ['资产概览', '资产设置', '基金', '现金', '财富', '存入资金', '加密货币'],
  '产品功能/账户与设置': ['我的', '专享特权', '我的卡券', '我的费率', '账户切换', '设置'],
  '产品功能/活动与奖励': ['任务中心', '兑换商城', '奖励记录', '邀请中心', 'LBCafe'],
