...
const ORDER: Record<string, string[]> = {
  ...
  '开户与账户': ['如何下载长桥App', '登录注册', '开通香港综合账户', '开通新加坡综合账户', '香港与新加坡账户对比', '模拟账户', '日内融账户', '虚拟资产账户', '专业投资者认证', '生物认证', '防诈骗提示', '账户常见问题', '账户切换', '我的', '我的费率', '我的卡券', '专享特权', '设置', '遗产处理', '标准账户停运与迁移'],
  ...
  // 故障排查
  '故障排查': ['APP网络连接排查', '收不到短信验证码', '恒生银行可疑账号澄清', '入金未到账怎么办', '出金失败怎么办', 'App登录失败怎么办', 'DDA授权失败怎么办', '订单提交失败怎么办', '期权行权异常怎么办'],
}
