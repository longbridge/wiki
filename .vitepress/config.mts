...
const ORDER: Record<string, string[]> = {
  ...
  // 产品功能
  '产品功能': ['客户端功能', '桌面端功能'],
  '产品功能/客户端功能': ['LongbridgeAI信息助手', '搜索', '关注', '市场', '动态', '资产', '我的'],
  '产品功能/客户端功能/关注': ['自选', '股单'],
  '产品功能/客户端功能/动态': ['动态'],
  '产品功能/客户端功能/市场': ['发现', '市场行情', '财富', '加密货币'],
  '产品功能/客户端功能/资产': ['资产概览', '现金', '全部功能', '账户切换', '基金', '存入资金', '资产设置'],
  '产品功能/客户端功能/我的': ['我的', '我的卡券', '我的费率', '专享特权', '任务中心', '兑换商城', '奖励记录', '行情商店', '邀请中心', '设置', 'LBCafe'],
