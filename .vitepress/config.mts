...
const ORDER: Record<string, string[]> = {
  ...
  // 账户相关
  '账户相关': ['下载', '登录注册', '开户', '账户认证', '账户安全', '特殊场景处理', '销户与迁移'],
  '账户相关/登录注册': ['登录注册'],
  '账户相关/下载': ['下载'],
  ...
  '股票交易/分红与公司行动': ['派息与特殊派息', '送股与选股派息', '供股权派发', '拆合股', '公司行动对长期订单影响'],
  '股票交易/股票转仓': ['香港股票转仓', '新加坡股票转仓', '各券商转入指引', '主子账户股票划转', '实物股票', '转仓常见问题'],
  '股票交易/桌面端工具': ['图表交易', '市场深度', '自定义布局', '桌面端快捷键'],

  // 行情服务
  '行情服务': ['市场行情', '行情权限规则', '行情数据字段介绍', '个股F10资料', '个股财务分析', 'ETF行情与全景', '个股公告与讨论', '资金流向'],

  // App 功能（待 R2-R5 完成后逐步消除）
  'App功能': ['行情与数据', '资产与持仓', '账户与设置', '活动与奖励', '全部功能'],
  'App功能/行情与数据': ['LongbridgeAI信息助手', '市场行情', '发现', '动态', '搜索', '自选', '股单', '行情商店'],
  'App功能/资产与持仓': ['资产概览', '资产设置', '基金', '现金', '财富', '存入资金', '加密货币'],
  'App功能/账户与设置': ['我的', '专享特权', '我的卡券', '我的费率', '账户切换', '设置'],
  'App功能/活动与奖励': ['任务中心', '兑换商城', '奖励记录', '邀请中心', 'LBCafe'],
  ...
  '营销活动与奖励/活动类型': ['活动资格说明', '邀请活动', '基础活动', '留存活动', '抽奖活动', '秒杀活动', '交易挑战', '交易排名', '交易红包', '助力活动'],
